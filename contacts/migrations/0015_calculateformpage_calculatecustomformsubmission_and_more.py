# Generated by Django 5.0.6 on 2024-06-11 12:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contacts', '0014_alter_customformsubmission_options_and_more'),
        ('wagtailcore', '0093_uploadedfile'),
    ]

    operations = [
        migrations.CreateModel(
            name='CalculateFormPage',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='contacts.calculateformpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
